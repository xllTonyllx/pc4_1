...
import modelo.MaterialesDAO;

@WebServlet(name = "MaterialesController", urlPatterns = {"/MaterialesController"})
public class MaterialesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(accion == null || accion.isEmpty()){
            ...
            List<Materiales> listaMateriales = materialesDAO.listarMateriales();
            ...
            materialesDAO.insertar(material);
            dispatcher = request.getRequestDispatcher("Materiales/index.jsp");
            List<Materiales> listaMateriales = materialesDAO.listarMateriales();
            request.setAttribute("lista", listaMateriales);
        }
