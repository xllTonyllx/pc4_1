 ...
 * @author DaFi
 */
public class MAterialesDao2 {
    Connection conexion;
    
    public MAterialesDao2(){
    ...
    public List<Materiales> listarMateriales(){
        ...
        try{
            ps = conexion.prepareStatement("SELECT codMaterial,codCategoria,nombreMaterial,cantidad FROM Materiales WHERE codCategoria="+"'3"+"'");
            rs = ps.executeQuery();
